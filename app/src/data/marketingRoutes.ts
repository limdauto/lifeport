...
export function getMarketingRoute(slug: string): MarketingRoute | undefined {
  return marketingRoutes.find((r) => r.slug === slug);
}

export const routePageHrefs: Record<string, string> = {
  professionals: '/professionals',
  'uk-to-dubai': '/routes/uk-to-dubai',
  'families-uk': '/routes/families-uk',
};
